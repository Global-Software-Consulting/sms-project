...
export default function Login() {
  ...
  // Surface OAuth errors that arrive as `?error=...` (e.g. when the backend
  // bounces the user back to /auth/login after a 403/503 from the OAuth start
  // endpoint).
  useEffect(() => {
      ...
      <div className="grid w-full max-w-6xl items-center gap-8 lg:grid-cols-2">
        ...
        <div className="hidden space-y-6 lg:block">
          ...
          <div className="from-primary/10 to-accent/10 border-primary/20 rounded-lg border bg-gradient-to-br p-6">
            ...
            <p className="text-muted-foreground text-sm">
              Check out our new V3 Premium providers with 99.9% success rates
        ...
        <Card className="relative w-full border-[var(--glass-border)] shadow-[var(--glass-shadow-3)] backdrop-blur-[var(--glass-blur)]">
          <CardHeader className="space-y-1 text-center">
            ...
            <Link
              href="/"
              className="from-primary to-accent mx-auto mb-4 flex h-16 w-16 items-center justify-center overflow-hidden rounded-2xl bg-gradient-to-br transition-transform hover:scale-105"
            >
              {siteLogo ? (
